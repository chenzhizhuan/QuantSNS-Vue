...
const locale = {
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR are external trading interfaces that require local deployment of QuantSNS. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or IB Gateway terminal) on your local machine.',
  ...
  'profile.exchange.desktopBrokersDisabledFallback': 'Deploy QuantSNS on your own machine or private server and install TWS, IB Gateway, or Alpaca.',
