...
const locale = {
  ...
  "aiAssetAnalysis.copilot.welcomeTitle": "Control QuantSNS with plain language",
  ...
  'notice.event.login.title': 'QuantSNS login alert · {reason}',
  ...
  'notice.event.profileTest.title': 'QuantSNS notification test',
  ...
  'trading-assistant.form.localDeploymentHint': 'IBKR and MT5 are external trading interfaces that require local deployment of QuantSNS. Cloud SaaS mode is not supported. Please ensure you have installed and configured the trading software (TWS/IB Gateway or MT5 terminal) on your local machine.',
  ...
  'settings.commercialLicense.body': 'QuantSNS is provided for personal study and research only. Any form of commercial use — including but not limited to running it as a public SaaS, reselling it, offering managed-trading services, paid advisory or fund-management products — requires a written commercial license from us beforehand. Unauthorized commercial deployments will be pursued through legal channels.',
  ...
  'agentTokens.description': 'Issue and manage tokens that let external AI agents (Cursor, Claude Code, Codex, MCP, custom bots) call this QuantSNS instance through /api/agent/v1.',
  ...
  'globalMarket.calendarFinnhubForbidden': 'The current source cannot access the economic calendar endpoint. QuantSNS prefers Trading Economics free access and AkShare fallback.',
  ...
  'trading-assistant.editor.docsIntroDesc': 'These are the commonly used QuantSNS script strategy APIs and lifecycle hooks, so you can code and look up usage side by side.',
  ...
  'quickTrade.tpslRecordOnlyHint': 'Note: TP/SL prices are saved in QuantSNS trade records only. They are not sent to the exchange as native TP/SL or trigger orders. Set exchange-side TP/SL on the exchange if you need that.',
  ...
  'profile.exchange.openAccountPromo': 'QuantSNS exclusive signup — up to 20% commission rebate',
  ...
  'profile.exchange.localDeploymentHint': 'This broker requires local deployment of QuantSNS to use.',
  'profile.exchange.desktopBrokersDisabledTitle': 'IBKR / MT5 disabled on this server',
  'profile.exchange.desktopBrokersDisabledFallback': 'Deploy QuantSNS on your own machine or private server and install TWS, IB Gateway, or MetaTrader 5.',
...
const copilotI18nPatch = {
  ...
  "aiAssetAnalysis.copilot.strategyExamples.code": "Turn my trading idea into a QuantSNS Python ScriptStrategy with trend filter, entries/exits, position sizing, stop/take-profit, logs, and validation steps.",
